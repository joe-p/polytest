import pytest
from fixtures import ValidVehicle, InvalidVehicle, BrokenVehicle
# Polytest Suite: car

# Polytest Group: broken vehicle

@pytest.mark.group_broken_vehicle
def test_flat_tire_is_caught(broken_vehicle: BrokenVehicle):
    """The function for checking tires should return false if the vehicle has a flat tire"""
    raise Exception("TEST NOT IMPLEMENTED")

@pytest.mark.group_broken_vehicle
def test_broken_headlight_is_caught(broken_vehicle: BrokenVehicle):
...
def test_extra_headlight_throws_error(invalid_vehicle: InvalidVehicle):
    """Having an extra headlight is invalid and should throw an error"""
    raise Exception("TEST NOT IMPLEMENTED")

@pytest.mark.group_invalid_vehicle
def test_extra_tire_throws_error(invalid_vehicle: InvalidVehicle):
